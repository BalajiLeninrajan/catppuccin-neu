...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/BalajiLeninrajan/catppuccin-neu@v0.3.1/css/index.css" />
```
...
```sh
pnpm add github:BalajiLeninrajan/catppuccin-neu#v0.3.1
```
