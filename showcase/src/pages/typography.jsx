...
export default function TypographyPage() {
  return (
    <Doc
      title="Typography"
      lede="A sans-first system. Inter carries every role — headings, labels, values, metadata — and JetBrains Mono is scarce: it appears only where the content is literally code. Pick the role, not the face; no bare font-family utility exists."
    >
      <p class="cn-copy">
        ...
        on the sans face, so figures align in columns without reaching for mono.
      </p>

      <Demo
        title="cn-display — 820 · clamp(38–64px) · -0.055em · balance"
        classes="cn-display"
      >
        <h1 class="cn-display">
      ...
      <Demo
        title="cn-display-sm — 820 · clamp(30–46px) · -0.045em"
      ...
      <p class="cn-copy">
        ...
        renders mauve, upright — the one sanctioned inline highlight.
      </p>
      ...
      <Demo
        title="cn-microlabel — 700 · 9px · +0.08em · uppercase · overlay-1"
      ...
      <Demo
        title="Tabular numerals — sans figures align in columns"
      ...
      <p class="cn-copy">
        Every digit above is Inter with{" "}
        <code class="cn-code">tabular-nums</code> — equal-width figures, so the
        decimal points stack without a monospace face.
      </p>

      <Props
        title="Role reference"
        rows={[
          { name: ".cn-display", values: "sans", default: "820 · clamp(38px, 5vw, 64px) · -0.055em", notes: "Hero headline; text-wrap: balance; em turns mauve." },
          { name: ".cn-display-sm", values: "sans", default: "820 · clamp(30px, 4.6vw, 46px) · -0.045em", notes: "Page titles; same em rule." },
          ...
          { name: ".cn-microlabel", values: "sans", default: "700 · 9px · +0.08em · uppercase", notes: "Smallest metadata; overlay-1." },
      ...
      <p class="cn-copy">
        ...
        <code class="cn-code">.terminal</code> for log output. Labels,
        microlabels, eyebrows, values, chips, table headers — all sans. If a
        string is not code, a CLI command, or machine output, it does not get
        mono.
      </p>
